 ...
 */
/** @type {?} */
var LOAD_WIDEGTS_LIBRAIRIES = createAction('[SE - Widgets Libraries] Load Widgets Libraries');
/** @type {?} */
var LOAD_WIDEGTS_LIBRAIRIES_SUCCESSFULLY = createAction('[SE - Widgets Libraries] Load Widgets Libraries Successfully', props());
/** @type {?} */
var LOAD_WIDEGTS_LIBRAIRIES_FAILED = createAction('[SE - Widgets Libraries] Load Widgets Libraries Failed', props());
...
/** @type {?} */
var getWidgetsLibrairiesState = createFeatureSelector('SE - Widgets Librairies');
var ɵ2 = /**
 * @param {?} state
 * @return {?}
 */
...
/** @type {?} */
var getWidgetsLibrairies = createSelector(getWidgetsLibrairiesState, (ɵ2));
var ɵ3 = /**
 * @param {?} widgetsLibrairies
 * @return {?}
 */
...
/** @type {?} */
var getAllWidgets = createSelector(getWidgetsLibrairies, (ɵ3));
var ɵ4 = /**
 * @param {?} widgets
 * @param {?} props
 * @return {?}
...
/** @type {?} */
var getAvailableWidgetsForGivenScreenType = createSelector(getAllWidgets, (ɵ4));
var ɵ5 = /**
 * @param {?} widgets
 * @param {?} __1
 * @return {?}
...
/** @type {?} */
var getWidgetsToAutoGenerateSection = createSelector(getAvailableWidgetsForGivenScreenType, (ɵ5));
var ɵ6 = /**
 * @param {?} widgets
 * @return {?}
 */
...
/** @type {?} */
var getAllLayoutsWidgets = createSelector(getAllWidgets, (ɵ6));
var ɵ7 = /**
 * @param {?} widgets
 * @param {?} __1
 * @return {?}
...
/** @type {?} */
var getWidgetByName = createSelector(getAllWidgets, (ɵ7));
/** @type {?} */
 ...
 */
/** @type {?} */
var LOAD_SCREENS_LIBRAIRIES = createAction('[SE - Screens Libraries] Load Screens Libraries');
/** @type {?} */
var LOAD_SCREENS_LIBRAIRIES_SUCCESSFULLY = createAction('[SE - Screens Libraries] Load Screens Libraries Successfully', props());
/** @type {?} */
var LOAD_SCREENS_LIBRAIRIES_FAILED = createAction('[SE - Screens Libraries] Load Screens Libraries Failed', props());
...
/** @type {?} */
var screensLibrairiesReducer = createReducer(initialState$1, on(LOAD_SCREENS_LIBRAIRIES, (ɵ0$1)), on(LOAD_SCREENS_LIBRAIRIES_SUCCESSFULLY, (ɵ1$1)));
/**
 * @param {?} state
 * @param {?} action
 * @return {?}
...
/** @type {?} */
var getScreenssLibrairiesState = createFeatureSelector('SE - Screens Librairies');
var ɵ2$1 = /**
 * @param {?} state
 * @return {?}
 */
function (state) { return state.data; };
/** @type {?} */
var getScreensLibrairies = createSelector(getScreenssLibrairiesState, (ɵ2$1));
var ɵ3$1 = /**
 * @param {?} screensLibrairies
 * @return {?}
 */
...
/** @type {?} */
var getAllScreens = createSelector(getScreensLibrairies, (ɵ3$1));
var ɵ4$1 = /**
...
/** @type {?} */
var getScreensTemplateForGivenScreens = createSelector(getAllScreens, (ɵ4$1));
var ɵ5$1 = /**
 * @param {?} allScreensTemplates
 * @param {?} __1
 * @return {?}
...
/** @type {?} */
var getScreenTemplate = createSelector(getAllScreens, (ɵ5$1));
/** @type {?} */
 ...
 */
/** @type {?} */
var LOAD_MODELS = createAction('[SE Models] Load Models');
/** @type {?} */
var LOAD_MODELS_SUCCESSFULLY = createAction('[SE Models] Load Models Successfully', props());
/** @type {?} */
var LOAD_MODELS_FAILED = createAction('[SE Models] Load Models Failed', props());
...
/** @type {?} */
var modelsReducer = createReducer(initialState$2, on(LOAD_MODELS, (ɵ0$2)), on(LOAD_MODELS_SUCCESSFULLY, (ɵ1$2)));
/**
 * @param {?} state
 * @param {?} action
 * @return {?}
...
/** @type {?} */
var getModelsState = createFeatureSelector('SE - Models');
var ɵ2$2 = /**
 * @param {?} state
 * @return {?}
 */
...
/** @type {?} */
var getAllModels = createSelector(getModelsState, (ɵ2$2));
var ɵ3$2 = /**
 * @param {?} entities
 * @param {?} __1
 * @return {?}
...
/** @type {?} */
var getModel = createSelector(getAllModels, (ɵ3$2));
/** @type {?} */
var key$2 = 'SE - Models';
// private
...
var StoreDisplayerComponent = /** @class */ (function () {
    ...
    function (categories) {
         ...
         */
        function (category) {
            return __assign({}, category, { components: orderBy(category.components.filter((/**
                 * @param {?} component
                 * @return {?}
                 */
                function (component) {
